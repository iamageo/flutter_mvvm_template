...
class _$SuccessImpl<T> implements Success<T> {
  _$SuccessImpl({required this.data});
...
abstract class Success<T> implements ApiResponse<T> {
  factory Success({required final T data}) = _$SuccessImpl<T>;
...
class _$ErrorImpl<T> implements Error<T> {
  _$ErrorImpl({required this.message});
...
abstract class Error<T> implements ApiResponse<T> {
  factory Error({required final String message}) = _$ErrorImpl<T>;
